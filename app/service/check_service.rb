module CheckService
  ...
  # @see HandService
  def self.poker_hand(is_all_same_suits, is_sequence_numbers, same_numbers)
    @check_result = if is_all_same_suits && is_sequence_numbers
                      STRAIGHT_FLUSH
                    elsif same_numbers == [1, 4]
                      FOUR_OF_A_KIND
                    elsif same_numbers == [2, 3]
                      FULL_HOUSE
                    elsif is_all_same_suits
                      FLUSH
                    elsif is_sequence_numbers
                      STRAIGHT
